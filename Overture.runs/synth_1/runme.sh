...
HD_PWD='E:/Vivado Projects/Overture/Overture.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OVERTURE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OVERTURE.tcl
