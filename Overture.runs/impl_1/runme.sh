...
HD_PWD='E:/Vivado Projects/Overture/Overture.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OVERTURE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OVERTURE.tcl -notrace
